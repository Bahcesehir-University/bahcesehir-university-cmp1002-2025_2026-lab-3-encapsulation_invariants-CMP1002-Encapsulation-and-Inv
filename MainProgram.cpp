...
public:
    ...
    explicit Temperature(double celsius) {
        ...
        if (celsius < -273.15 ){
            throw invalid_argument("temperature value check");
        }
        celsius_ = celsius;
    }
...
public:
    ...
    void deposit(double amount) {
        // TODO: Implement
        if(amount <=0){
            throw invalid_argument("deposit amount");
        }
        balance_+=amount;
    }
    ...
    void withdraw(double amount) {
        // TODO: Implement
        if(amount <=0){
            throw invalid_argument("withdrawal amount");
        }
        if(amount> balance_){
            throw runtime_error("Inaufficient funds");
        }
        balance_ -=amount;
    }
